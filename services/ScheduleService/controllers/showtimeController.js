// Controller factory for ScheduleService route handlers
...
module.exports = ({ Showtime, fetchMovieById, fetchRoomsByTheater }) => {
  return {
    ...
    generateShowtimes: async (req, res) => {
      const {
        theaterId,
        movieId,
        startDate,
    ...
    updateShowtimePrices: async (req, res) => {
